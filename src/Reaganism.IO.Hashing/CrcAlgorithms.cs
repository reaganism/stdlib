...
public sealed class UncachedPolynomialCrc32Variant1 : ICrc32
{
    private static readonly Dictionary<uint, UncachedPolynomialCrc32Variant1> instances = new();

    private readonly uint polynomial;

    private UncachedPolynomialCrc32Variant1(uint polynomial)
    {
    ...
    public uint Hash(uint crc, byte[] data)
    {
        crc = ~crc;
    ...
    public static UncachedPolynomialCrc32Variant1 GetInstance(uint polynomial)
    {
        if (instances.TryGetValue(polynomial, out var instance))
        {
            return instance;
        }

        return instances[polynomial] = new UncachedPolynomialCrc32Variant1(polynomial);
    }
}

public sealed class UncachedPolynomialCrc32Variant2 : ICrc32
{
    private static readonly Dictionary<uint, UncachedPolynomialCrc32Variant2> instances = new();

    private readonly uint polynomial;

    private UncachedPolynomialCrc32Variant2(uint polynomial)
    {
        this.polynomial = polynomial;
    }
    ...
    public static UncachedPolynomialCrc32Variant2 GetInstance(uint polynomial)
    {
        if (instances.TryGetValue(polynomial, out var instance))
        {
            return instance;
        ...
        return instances[polynomial] = new UncachedPolynomialCrc32Variant2(polynomial);
    }
}

public sealed class GoldenAmdCrc32 : ICrc32
{
    public void SetupTable() { }
...
public sealed class GoldenIntelCrc32 : ICrc32
{
